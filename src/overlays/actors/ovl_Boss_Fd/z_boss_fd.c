...
void BossFd_Fly(BossFd* this, PlayState* play) {
    ...
    if (this->introState != BFD_CS_NONE) {
        ...
        switch (this->introState) {
            ...
            case BFD_CS_EMERGE:
                ...
                PRINTF2("this->timer[2] = %d\n", this->timers[2]);
                PRINTF2("this->timer[5] = %d\n", this->timers[5]);
                if (this->timers[2] == 0) {
    ...
    switch (this->work[BFD_ACTION_STATE]) {
        ...
        case BOSSFD_DROP_ROCKS:
            ...
            if (this->timers[1] == 0) {
                PRINTF2("BGCHECKKKKKKKKKKKKKKKKKKKKKKK\n");
...
void BossFd_Update(Actor* thisx, PlayState* play) {
    ...
    PRINTF2("FD MOVE END 1\n");
    BossFd_UpdateEffects(this, play);
    PRINTF2("FD MOVE END 2\n");
}
